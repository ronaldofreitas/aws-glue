...
persons = glueContext.create_dynamic_frame.from_catalog(
             ...
             table_name=tbl_persons)
print ("Count: ", persons.count())
persons.printSchema()


datasource0 = glueContext.create_dynamic_frame.from_catalog(database = db_name, table_name =tbl_persons, transformation_ctx = "datasource0")

datasink4 = glueContext.write_dynamic_frame.from_catalog(frame = datasource0, database = db_name, table_name = tbl_persons, transformation_ctx = "datasink4")
job.commit()

'''
# output s3 and temp directories
output_history_dir = "s3://awsglue-output-legislators/legislator_history"
output_lg_single_dir = "s3://awsglue-output-legislators/legislator_single"
output_lg_partitioned_dir = "s3://awsglue-output-legislators/legislator_part"
